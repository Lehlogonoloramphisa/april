    ...
    Route::middleware(role_middleware(Role::webPanelLoginRoles()))->group(function () {
        ...
        Route::namespace('Admin')->group(function () {
            ...
            Route::prefix('types')->group(function () {
                ...
                Route::get('/test', 'VehicleTypeController@test');
...
/*chat*/
        ...
        Route::group(['prefix' => 'chat',  'middleware' => 'permission:view-chat'], function () {
            Route::get('/', 'ChatController@index');
            Route::get('/fetch', 'ChatController@getAllChat');
            Route::get('by/admin', 'ChatController@byAdmin');
            Route::get('/create', 'ChatController@create');
            Route::post('store', 'ChatController@store');
            Route::get('edit/{chat}', 'ChatController@getById');
            Route::post('update/{chat}', 'ChatController@update');
            Route::get('toggle_status/{chat}', 'ChatController@toggleStatus');
...
/*configuration*/
        ...
        Route::prefix('system/settings')->group(function () {
            ...
            Route::post('/map/{setting}','SettingController@mapUpdate' );            
